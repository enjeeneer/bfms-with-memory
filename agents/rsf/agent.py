...
from agents.fb.models import ActorModel, ForwardRepresentation
from agents.rfb.models import RecurrentForwardRepresentation
from agents.rsf.models import RecurrentHILPFeatures
from agents.sf.models import HILPFeatures
...
class RSF(AbstractAgent):
    """
    Recurrent successor feature agent.
    """
